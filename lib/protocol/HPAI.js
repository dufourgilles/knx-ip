...
(function (KnxProtocol) {
    KnxProtocol[KnxProtocol["IPV4_UDP"] = KNXConstants_1.KNX_CONSTANTS.IPV4_UDP] = "IPV4_UDP";
    KnxProtocol[KnxProtocol["IPV4_TCP"] = KNXConstants_1.KNX_CONSTANTS.IPV4_TCP] = "IPV4_TCP";
})(KnxProtocol = exports.KnxProtocol || (exports.KnxProtocol = {}));
class HPAI {
    constructor(_host, _port = KNXConstants_1.KNX_CONSTANTS.KNX_PORT, _protocol = KNXConstants_1.KNX_CONSTANTS.IPV4_UDP) {
        this._port = _port;
