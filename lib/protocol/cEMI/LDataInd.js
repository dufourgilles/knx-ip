...
class LDataInd extends CEMIMessage_1.CEMIMessage {
    constructor(additionalInfo, control, srcAddress, dstAddress, npdu) {
        super(CEMIConstants_1.CEMIConstants.L_DATA_IND, CEMIMessage_1.CEMIMessage.GetLength(additionalInfo, control, srcAddress, dstAddress, npdu), additionalInfo, control, srcAddress, dstAddress, npdu);
    }
...
exports.LDataInd = LDataInd;
//# sourceMappingURL=LDataInd.js.map